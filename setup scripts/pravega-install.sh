...
helm install bookkeeper pravega/bookkeeper -f manifests/bk_vals.yaml --timeout=10m0s 
...
helm install pravega pravega/pravega -f manifests/values.yaml --timeout=10m0s
``
